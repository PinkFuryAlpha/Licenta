...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeRequests()
                .antMatchers(HttpMethod.POST, "/register", "/users/authenticate", "/users/forgot-password", "/users/reset-password", "/users/update-to-artist").permitAll()
                ...
                .antMatchers(HttpMethod.DELETE, "/songs/delete","/playlist/**").hasAnyRole(ARTIST)
